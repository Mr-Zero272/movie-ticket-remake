...
const FavoriteSuggestion = ({ listSuggestMovie, onClose }: Props) => {
    ...
    return (
        <article className="max-h-[33rem] min-h-96 w-64 flex-none overflow-x-hidden overflow-y-scroll rounded-lg px-5 dark:bg-[#121212] max-[1200px]:hidden">
                        ...
                        <div className="mt-3 overflow-hidden">
                            {listMovies.map((movie) => (
                                <div
                                    ...
                                    key={movie.id}
                                    onClick={() => handleChooseActiveMovie(movie.id)}
                                >
                                    <div className="w-1/3">
                                        <Image
